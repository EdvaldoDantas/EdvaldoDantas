...
Tenho experiência com autenticação e autorização com **JWT**, **ASP.NET Identity**, acesso a dados com **EF Core** e **Dapper**, além de interfaces usando **Vue.js**, **TailwindCSS** e **Blazor**.  
